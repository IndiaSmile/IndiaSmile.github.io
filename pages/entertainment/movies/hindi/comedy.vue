...
export default {
  ...
  data() {
    return {
      image: require('~/assets/images/hindi-comedy.jpg?resize'),
      title: 'Best Bollywood Comedies',
      article: [
        {
          text: `Every year bollywood churns out hundreds of Masala movies, kind of India’s term for comedy movies! They are based on opposite sex interactions, old age hilarity, and foolishness of the youth! Don’t think twice, just pick a movie from the list and laugh your days of isolation off! 🤣`,
        },
        {
          heading: 'Hera Pheri',
          ...
          image: require('~/assets/images/comedy-hera-pheri.jpg?resize'),
          rating: 8.2,
          buttons: [
            {
              type: 'Prime',
        ...
        },
        {
          ...
          image: require('~/assets/images/comedy-dhamaal.jpg?resize'),
          rating: 7.3,
          buttons: [
            {
              type: 'Netflix',
              link: 'https://www.netflix.com/watch/81213888?source=35',
            },
          ],
        },
        {
          ...
          image: require('~/assets/images/comedy-3-idiots.jpg?resize'),
          rating: 8.4,
          buttons: [
            {
              type: 'Prime',
        ...
        },
        {
          ...
          image: require('~/assets/images/comedy-munnabhai.jpg?resize'),
          rating: 8.1,
          buttons: [
            {
              type: 'Prime',
        ...
        },
        {
          ...
          image: require('~/assets/images/comedy-delhi-belly.jpg?resize'),
          rating: 7.5,
          buttons: [
            {
              type: 'Netflix',
              link: 'https://www.netflix.com/title/70152959',
            },
          ],
        },
        {
          ...
          image: require('~/assets/images/comdey-andaaz-apna-apna.jpg?resize'),
          rating: 8.2,
          buttons: [
            {
              type: 'Prime',
        ...
        },
        {
          ...
          image: require('~/assets/images/comedy-garam-masala.jpg?resize'),
          rating: 6.7,
          buttons: [
            {
              type: 'Hotstar',
        ...
        },
        {
          ...
          image: require('~/assets/images/comedy-hangama.jpg?resize'),
          rating: 7.5,
          buttons: [
            {
              type: 'Hotstar',
              link: 'https://www.hotstar.com/in/movies/hungama/1000050766',
            },
          ],
        },
        {
          ...
          image: require('~/assets/images/comedy-bheja-fry.jpg?resize'),
          rating: 7.6,
        ...
        },
        {
          ...
          image: require('~/assets/images/comedy-welcome.jpg?resize'),
          rating: 6.8,
          message: 'Available on Indian streaming platforms',
        },
      ],
