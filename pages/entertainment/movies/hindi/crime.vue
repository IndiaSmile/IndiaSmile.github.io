...
export default {
  ...
  data() {
    return {
      image: require('~/assets/images/hindi-crime.jpg?resize'),
      ...
      article: [
        ...
        },
        {
          ...
          rating: 8.1,
          image: require('~/assets/images/crime-kahani.jpg?resize'),
          buttons: [
            {
              type: 'Netflix',
              link: 'https://www.netflix.com/title/70236020',
            },
          ],
        },
        {
          ...
          rating: 8.1,
          image: require('~/assets/images/crime-a-wednesday.jpg?resize'),
          buttons: [
            {
              type: 'Netflix',
              link: 'https://www.netflix.com/title/70107499',
            },
          ],
        },
        {
          ...
          rating: 8.2,
          image: require('~/assets/images/crime-drishyam.jpg?resize'),
          buttons: [
            {
              type: 'Netflix',
              link: 'https://www.netflix.com/title/80068117',
            },
          ],
        },
        {
          ...
          rating: 8.0,
          image: require('~/assets/images/crime-special-26.jpg?resize'),
          buttons: [
            {
              type: 'Netflix',
              link: 'https://www.netflix.com/title/70273637',
            },
          ],
        },
        {
          ...
          rating: 6.8,
          image: require('~/assets/images/crime-raees.jpg?resize'),
          buttons: [
            {
              type: 'Netflix',
              link: 'https://www.netflix.com/title/80164778',
            },
          ],
        },
        {
          ...
          rating: 8.2,
          image: require('~/assets/images/crime-satya.jpg?resize'),
          buttons: [
            {
              type: 'Prime',
              link:
        ...
        },
        {
          ...
          rating: 7.1,
          image: require('~/assets/images/crime-shootout-at-lokhandwala.jpg?resize'),
          buttons: [
            {
              type: 'Netflix',
              link: 'https://www.netflix.com/title/70073018',
            },
          ],
        },
        {
          ...
          rating: 8.2,
          image: require('~/assets/images/crime-paan-singh-tomar.jpg?resize'),
          buttons: [
            {
              type: 'Netflix',
        ...
        },
        {
          ...
          rating: 8.1,
          image: require('~/assets/images/crime-omkara.jpg?resize'),
        ...
        },
        {
          ...
          rating: 7.6,
          image: require('~/assets/images/crime-sarkar.jpg?resize'),
          message: 'Available on Indian streaming platforms',
        },
        {
          ...
          rating: 7.9,
          image: require('~/assets/images/crime-ab-tak-chhappan.jpg?resize'),
          message: 'Available on Indian streaming platforms',
        },
      ],
    }
