      ...
      list: [
        {
          ...
          href: '/survival-pack/soaps',
          isDarkText: true,
        },
        {
          title: 'Sanitisers',
          subtitle: 'Get fit at home',
          image: require('~/assets/images/sanitizers.png'),
          color: 'rgba(230, 226, 225, 0.85)',
          href: '/survival-pack/sanitisers',
          isDarkText: true,
        },
        {
          title: 'Vegetables',
        ...
        },
        {
          ...
          href: '/survival-pack/grocery-essentials',
          isDarkText: false,
        },
      ],
    }
